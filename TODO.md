...
- CSS/Styling cleanup
  - This is the big pitfall of Tailwind CSS - you (or your LLM agent) just stacks random classNames, and eventually nobody knows what the purpose is of each style change being there.
  ...
  ```html
  <div className="input customInputElement"></div>
  ```
