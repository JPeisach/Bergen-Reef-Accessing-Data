...
export default function TankStatsPanel({ panelClass }) {
  ...
  return (
    <div className={panelClass}>
      <h2 className="text-lg font-bold text-base-content mb-3">Tank 1</h2>

      {/* TODO: Depending on how we insert observations, we need to  make sure any extra data doesn't show up here */}
      {elementData.length == 0 ? (
        <p className="text-base-content">Fetching data...</p>
      ) : (
        <ul className="space-y-1.5 text-sm text-base-content/80 font-medium">
