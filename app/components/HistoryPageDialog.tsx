                ...
                {type === "guide" && (
                  <div className="text-lg mt-2">
                    <p className="mb-3">
                      ...
                      , descending{" "}
                      <ArrowDownIcon className="inline w-4 h-4 text-gray-500 ml-1 align-text-bottom" />
                      ),
                    ...
                    <p className="mb-3">
                      To clear all existing filters, click on the{" "}
                      <b>Clear Filters</b> button.
                    </p>
                    <p className="mb-3">
                      To refresh the table and view the latest updates, click on
                      the <b>Refresh</b> button.
                    </p>
                    <p className="font-semibold underline mb-3">
                      For Administrators:
                    </p>
                    <p className="mb-3">
                      Click on the <b>Enter Edit Mode</b> button to create,
                      delete, and edit data.
                    </p>
                    <p className="mb-3">
                      To create data entries, click on the <b>Create</b> button.
                      Click on the dropdown menu to select an element and double
                      click on the cell in the <b>Value</b> column to type in
                      the measurement.
                    </p>
                    <p className="mb-3">
                      To delete data entries, select the desired entries using
                      the <b>checkboxes</b> on the leftmost table column and
                      click on the <b>Delete Selected</b> button.
                    </p>
                    <p>
                      To edit data entries, double click on the cell in the{" "}
                      <b>Value</b> column of the desired entry. You may only
                      edit the value or measurement of existing rows.
                    </p>
                  </div>
                )}
                {type !== "guide" && <p className="text-lg mt-2">{message}</p>}
                {type === "warning" ? (
