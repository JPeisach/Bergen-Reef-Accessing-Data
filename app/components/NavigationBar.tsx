        ...
        <Link href="/">
          <div className="flex items-center gap-3 min-w-0 py-2">
            <img
              ...
              alt="Coral Reef Logo"
            />
            <h1 className="text-primary-content font-semibold text-base sm:text-xl md:text-2xl whitespace-nowrap truncate min-w-0">
            ...
            <TabList className="flex flex-col">
                  ...
                  {() => (
                    <button
                      className={clsx(
                        "navbar-tabitem",
                        defaultIndex === 0
                          ? "bg-primary outline-solid outline-0 outline-dark-orange text-white font-bold"
              ...
              <a href="/profile" className="">
                <div className="flex flex-row flex-wrap">
                  <UserCircleIcon
                    className={clsx("size-8", "text-primary-content")}
                  />
                  {/* FIXME: wrap text neatly with the icon */}
                  <p className="text-base sm:text-lg md:text-xl text-primary-content font-semibold px-2 py-0.5 whitespace-pre-wrap">
                    Welcome {username}!
                  </p>
                </div>
              </a>
